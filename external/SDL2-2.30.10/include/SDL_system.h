 ...
 * resource leak.
 *
 * \param _renderer the _renderer from which to get the associated D3D device
 ...
 * resource leak.
 *
 * \param _renderer the _renderer from which to get the associated D3D11 device
 ...
 * resource leak.
 *
 * \param _renderer the _renderer from which to get the associated D3D12 device
